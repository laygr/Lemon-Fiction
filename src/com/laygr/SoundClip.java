...
public class SoundClip {
	 ...
	 * 
	 * @param filename
	 *            es el <code>String</code> del archivo.
	 */
	public SoundClip(String nombre, String filename) {
	 ...
	 * 
	 * @param _repeat
	 *            es un <code>entero</code> que es el numero de repeticiones.
	 */
	 ...
	 * 
	 * @param _filename
	 *            es un <code>String</code> con el nombre del archivo.
	 */
	 ...
	 * 
	 * @param audiofile
	 *            es un <code>String</code> con el nombre del archivo de sonido.
	 */
